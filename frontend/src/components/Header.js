...
export const Header = () => {
	...
	return (
		<div className="fixed w-full p-2 text-color-logo flex justify-between mt-[-3%] items-center ">
			<div className="flex flex-col items-center  md:scale-75  sm:scale-50 text-center text-white font-extrabold">
